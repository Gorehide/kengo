...
$listText = array("","Text Line 1","Text Line 2","Text Line 3","Text Line 4");
//LOGO
...
while($rowc = mysql_fetch_array($resc))
{
    ...
    $concepto = str_replace('</p>', '', $concepto);
    $concepto = str_replace("&euro;", " !", $concepto);
    //$concepto .= $pdf->UnorderedList($listText,$mainFontSize,$Margin); 
    $concepto = str_replace("<ul>", "", $concepto);
    $concepto = str_replace("</ul>", "", $concepto);
    $concepto = str_replace("<ol>", "", $concepto);
    $concepto = str_replace("</ol>", "", $concepto);
    $concepto = str_replace("<li>", "    • ", $concepto);
    $concepto = str_replace("</li>", "", $concepto);

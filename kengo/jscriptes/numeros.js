...
(function($){
	...
	$.fn.format=function(settings,wrongFormatHandler)
	{
		...
		this.keypress(function(d)
		{
			...
			if((d.ctrlKey&&(a==97||a==65||a==120||a==88||a==99||a==67||a==122||a==90||a==118||a==86||a==45))||(a==46&&d.which!=null&&d.which==0)) return true;
			if(a<48||a>57)
			{
				if(settings.type=="decimal")
				{
				...
				{
					if(a==43||(a>34&&a<38)){return true}
					if(a==8||a==9||a==13||a==46||a==43&&this.value.indexOf("+")==1)return true;
					return false
				}
				else if(settings.type=="numi")
				{
					if(a==45&&this.value.length==0)return false;
					if(a==8||a==9||a==13||a==46||a>34&&a<38){return true}
					return false
				}
				else if(settings.type=="alphabet")
				{

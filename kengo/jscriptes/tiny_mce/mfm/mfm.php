<?php
/*************************************************************************
		Program: File anager for TinyMCE 3.
		Version: 0.12
		Author: Mad182
...
$file_root = '../../../../archivos'; 		//where to store files, must be created and writable
$root_path = '/ikerlan/kengo/jscriptes'; 					//path from webroot, without trailing slash. If your page is located in http://www.example.com/john/, this should be '/john'
$thmb_size = 100;       	//max size of preview thumbnail
$no_script = false;       //true/false - turns scripts into text files
$lang = 'es';           	//language (look in /mfm/lang/ for available)
...
function print_tree($dir = '.')
{
	global $root_path;
	//$dir = "../../../../archivos/";
	//$dir = "http:///produccion3.ath.cx/archivos/";
	//echo '<br /><br /><br />'.$dir.'<br />';
...
<body onload="load('mfm.php?status=<?php echo $uploadstatus; ?>&amp;viewdir=<?php echo $return; ?>','view-files');">
	<div id="browser-wrapper">
			...
			<ul class="dirlist">
				...
				<a href="#" title="<?php echo $lng['refresh_tree_title']; ?>" onclick="load('mfm.php?viewtree=true','view-tree'); return false;" id="refresh-tree">

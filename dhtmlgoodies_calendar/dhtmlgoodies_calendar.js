...
var languageCode = $("#urll").attr("idioma");	// Possible values: 	en,ge,no,nl,es,pt-br,fr
...
//PARA SABER LA URL BASE DE LA WEB
function str_replace(cadena, cambia_esto, por_esto)
{
      return cadena.split(cambia_esto).join(por_esto);
}
baseurl = $("#urll").attr("class");
var pathToImages = str_replace(baseurl,'kengo/','')+'images/';	// Relative to your HTML file
//alert(str_replace(baseurl,'kengo/',''));
...
switch(languageCode){
	...
	case "pt-br":  /* Brazilian portuguese (pt-br) */
		...
		break;
	case "fr":      /* French */
		var monthArray = ['Janvier','Février','Mars','Avril','Mai','Juin','Juillet','Aoút','Septembre','Octobre','Novembre','Décembre'];
	...
	case "hu":	/* Hungarian  - Remember to use UTF-8 encoding, i.e. the <meta> tag */
		...
		var monthArrayShort = ['Jan','Feb','Márc','Ápr','Máj','Jún','Júl','Aug','Szep','Okt','Nov','Dec'];
